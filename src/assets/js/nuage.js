...
function createCloud() {
  const cloudGeometry = new THREE.SphereGeometry(2, 42, 22); // Nuage de base en forme de sphère
  const cloudMaterial = new THREE.MeshPhongMaterial({
    color: 0x32CEFA, // Couleur de base du nuage
    transparent: true,
    opacity: 0.6,
    shininess: 100,
    emissive: 0x20b82, // Couleur d'émission subtile
